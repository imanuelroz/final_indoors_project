...
class SwinTransformerFineTuningADE20k(
    ...
    def __init__(self, subregion_classes=23, city_classes=10458,
        ...
        super().__init__()
        self.lr = 1e-3 #poi prova con 1e-6
    ...
    def forward(self, x):
        ...
        return dict(subregion_hat=subregion_hat, country_hat=country_hat, city_hat=city_hat, chain_hat=chain_hat) #chain_hat=chain_hat
