...
ig = IntegratedGradients(lambda x: model.forward_ig(x)['subregion_hat'])
...
fig_ig.savefig('/home/rozenberg/indoors_geolocation_pycharm/integrated_gradients/ig_rome_400_country.png')
